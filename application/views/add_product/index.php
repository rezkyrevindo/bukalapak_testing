    ...
    <section class="panel panel-default">
        <div class="panel-body">
            ...
            <form action="" class="form-horizontal " role="form">
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Gambar</label>
                    <div class="col-sm-3">
                        <label class="control-label small" for="file_img">File Gambar (jpg/png):</label> <input type="file" name="file_img">
                    </div>
                </div> <!-- form-group // -->
